...
export const settingSections = [
  {
    ...
    description:
      "Update your personal information including name, email, avatar, branch and year",
  },
  {
    id: "platforms",
    icon: "link",
    ...
    description:
      "Manage your coding platform connections for LeetCode, CodeChef, Codeforces, and GeeksForGeeks",
  },
];

export const analyticsStats = [
  { label: "Avg. Daily Problems", value: "4.2", color: "#10B981" },
  { label: "Active Days", value: "287", color: "#35b9f1" },
