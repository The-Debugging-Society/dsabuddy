...
const mapping = [
  ...
  },
  {
    "title": "STL",
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/frequency-of-the-most-frequent-element?utm=codolio",
    "needs_review": false
  },
  {
  ...
  },
  {
    ...
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/reverse-string?utm=codolio",
    "needs_review": false
  },
  {
  ...
  },
  {
    ...
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/kth-largest-element-in-an-array?utm=codolio",
    "needs_review": false
  },
  {
  ...
  },
  {
    ...
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/missing-number?utm=codolio",
    "needs_review": false
  },
  {
  ...
  },
  {
    ...
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/longest-consecutive-sequence/solutio",
    "needs_review": false
  },
  {
  ...
  },
  {
    ...
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/subarray-sum-equals-k?utm=codolio",
    "needs_review": false
  },
  {
  ...
  },
  {
    ...
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/subarrays-with-k-different-integers?utm=codolio",
    "needs_review": false
  },
  {
  ...
  },
  {
    ...
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/palindrome-partitioning?utm=codolio",
    "needs_review": false
  },
  {
    "title": "Word Search",
  ...
  },
  {
    "title": "Word Break",
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/word-break?utm=codolio",
    "needs_review": false
  },
  {
  ...
  },
  {
    "title": "LRU Cache",
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/lru-cache?utm=codolio",
    "needs_review": false
  },
  {
    "title": "LFU Cache",
  ...
  },
  {
    ...
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/merge-k-sorted-lists?utm=codolio",
    "needs_review": false
  },
  {
  ...
  },
  {
    ...
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/number-of-connected-components-in-an-undirected-graph?utm=codolio",
    "needs_review": false
  },
  {
  ...
  },
  {
    "title": "DFS",
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/surrounded-regions?utm=codolio",
    "needs_review": false
  },
  {
  ...
  },
  {
    ...
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/shortest-path-in-binary-mat",
    "needs_review": false
  },
  {
  ...
  },
  {
    ...
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/longest-common-subsequence?utm=codolio",
    "needs_review": false
  },
  {
  ...
  },
  {
    ...
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/longest-increasing-subsequence?utm=codolio",
    "needs_review": false
  },
  {
  ...
  },
  {
    ...
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/longest-string-chain?utm=codolio",
    "needs_review": false
  },
  {
  ...
  },
  {
    ...
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/single-number?utm=codolio",
    "needs_review": false
  },
  {
  ...
  },
  {
    ...
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/find-the-index-of-the-first-occurrence-in-a-string?utm=codolio",
    "needs_review": false
  },
  {
  ...
  },
  {
    ...
    "platform": "leetcode",
    "link": "https://leetcode.com/problems/shortest-palindrome?utm=codolio",
    "needs_review": false
  },
  {
...
async function main() {
  console.log("Starting Striver A2Z Sheet links update...");
  await prisma.$connect();
  
  try {
    const sheet = await prisma.sheet.findUnique({
      where: { slug: "strivers-a2z-dsa-sheet" }
    });
    
    if (!sheet) {
      console.error("Sheet 'strivers-a2z-dsa-sheet' not found in database.");
      return;
    }
    
    console.log(`Found sheet '${sheet.name}' (ID: ${sheet.id}).`);
    
    // Fetch all problems for this sheet
    const problems = await prisma.sheetProblem.findMany({
    ...
    // Build a lookup map of mapping entries
    const mappingMap = {};
    for (const item of mapping) {
      const norm = normalize(item.title);
      mappingMap[norm] = item;
    }
    ...
    for (const problem of problems) {
      ...
      const match = mappingMap[normTitle];
      
      if (match) {
        await prisma.sheetProblem.update({
          where: { id: problem.id },
          data: { practiceUrl: match.link }
        });
        updatedCount++;
      } else {
        unmatchedCount++;
        console.warn(`Unmatched problem in database: "${problem.title}"`);
      }
    }
    
    console.log("Striver A2Z Sheet update completed successfully.");
    console.log(`Updated problems: ${updatedCount}`);
    console.log(`Unmatched problems: ${unmatchedCount}`);
  } catch (error) {
    console.error("Error updating sheet links:", error);
  } finally {
