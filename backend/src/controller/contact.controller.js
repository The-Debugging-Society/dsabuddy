...
import { sendEmail } from './mailerController.js';
...
// so submitters can't inject markup (links, tracking pixels, layout breaks).
...
// Collapse newlines/whitespace for values placed in the email subject line
// (prevents header injection).
const sanitizeHeader = (str = '') => String(str).replace(/[\r\n]+/g, ' ').trim();

const internalNotificationHtml = (name, email, message) => `
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8" />
